...
[![License](https://img.shields.io/github/license/NSIS-Dev/language-data?style=for-the-badge)](LICENSE)
[![Version: npm](https://img.shields.io/npm/v/@nsis/language-data?style=for-the-badge)](https://www.npmjs.org/package/@nsis/language-data)
[![CI](https://img.shields.io/github/actions/workflow/status/NSIS-Dev/language-data/default.yml?logo=nodedotjs&logoColor=white&style=for-the-badge)](https://github.com/NSIS-Dev/language-data/actions/workflows/default.yml)
